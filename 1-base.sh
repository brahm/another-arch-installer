...
pacstrap /mnt base linux linux-firmware linux-headers intel-ucode acpi acpi_call lm_sensors dosfstools xfsprogs sudo zsh nano git
echo "...done!"
sleep 2
...
echo "This will continue from threre..."
arch-chroot /mnt
